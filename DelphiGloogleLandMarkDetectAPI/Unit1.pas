...
begin
 ...
 APIkey := 'AIzaSyDQKUvxXBmJarvphQMdrs0TuIm7s57gJiM';
 ...
 '{"requests": [{"features": [{"maxResults": %s,"type": "LANDMARK_DETECTION"}],"image": {'+
 '"source": {"imageUri": "%s"}}}]}', [Edit2.text, Edit1.text]);

 RESTResponse1.RootElement := 'responses[0].landmarkAnnotations';
