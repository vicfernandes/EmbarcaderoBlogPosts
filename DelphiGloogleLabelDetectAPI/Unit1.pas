...
begin
 ...
 APIkey := 'AIzaSyBLSdcJ7BKTrM-0CSBHJ9u4yZCOXeSU1P0';
 ...
 '{"requests": [{"features": [{"maxResults": %s,"type": "LABEL_DETECTION"}],"image": {'+
 '"source": {"imageUri": "%s"}}}]}', [Edit2.text, Edit1.text]);

 RESTResponse1.RootElement := 'responses[0].labelAnnotations';
