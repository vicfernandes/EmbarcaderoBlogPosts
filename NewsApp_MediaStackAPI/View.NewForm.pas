...
begin
 ...
 RESTClient1.BaseURL := 'http://api.mediastack.com/v1/news';
 ...
 RESTRequest1.Resource := Format('?access_key=%s&categories=%s&languages=%s&sources=%s', [edit1.Text, edit2.Text, edit3.Text, edit4.Text]);
